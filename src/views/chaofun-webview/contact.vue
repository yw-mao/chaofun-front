    ...
    <div class="content">
        <div class="top">
          ...
          <div class="desc">请最新版App私聊 cijianzy，或者添加下面微信进群反馈，有红包哦~</div>
            <div class="erweima">
                <img @click="showImg" src="https://chaofun.oss-cn-hangzhou.aliyuncs.com/biz/10c40905c46e8c9c65d8d95b9fb25bdf.jpg" alt="">
            </div>
        </div>
    </div>
  ...
  methods:{
      showImg(){
          window.flutter_inappwebview.callHandler('viewImage',{
              data: ['https://chaofun.oss-cn-hangzhou.aliyuncs.com/biz/10c40905c46e8c9c65d8d95b9fb25bdf.jpg'],
              index: 0
          })
