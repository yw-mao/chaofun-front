 ...
 <div class="container">
     <div :style="{height:ISPHONE?'400px;':''}">
        ...
        <div class="logo_con">
            ...
            <div class="build_info">
                <div class="info_item"> iOS: 2.24.1 | Android: 2.24.1 </div>
                <div class="info_item"> 更新时间 2021.08.26 </div>
            </div>
        </div>
    ...
    <div class="detail">
        ...
        <div class="intos">
            ...
            <div class="desc">
                炒饭超Fun App是一款兴趣聚合的优质内容社区，聚合全网热门资讯、热门话题、优质好图等多个板块，在这里，你可以分享你喜欢的内容，世界那么大，来炒饭看看！
            </div>
        </div>
    </div>
    <div class="a">
