                ...
                if("granted" != status){
                    ...
                    var notify = new Notification( title, {
                        ...
                        data: {forumId: data.forumId},
                                ...
                                icon:data.type=='image'?(self.imgOrigin+data.content):('https://chaofun.oss-cn-hangzhou.aliyuncs.com/biz/08a2d3a676f4f520cb99910496e48b4e.png?x-oss-process=image/resize,h_80/format,webp/quality,q_75'),//通知的缩略图,//icon 支持ico、png、jpg、jpeg格式
